...
(* OASIS_START *)
(* DO NOT EDIT (digest: ebacd3af78cfe7782dbcf914e6f2b103) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build ppx-deriving support for lens";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "lens";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "lens_ppx_deriving";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "ppx_deriving";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "lens";
                   ...
                   {
                      lib_modules = ["Ppx_deriving_lens"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lens";
                      lib_findlib_name = Some "ppx_deriving";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "lens";
                           InternalLibrary "lens_ppx_deriving";
                           FindlibPackage ("ppx_deriving", None);
                   ...
                   {exec_custom = false; exec_main_is = "test_lens.ml"});
               Test
                 ({
                     cs_name = "test_ppx";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\157\244Km\185S\135\211\000\149\152\193\199y\\6";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
